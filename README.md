...
1. Clona el repositorio:
   ```bash
   git clone [https://github.com/TuUsuario/mcTUI.git](https://github.com/TuUsuario/mcTUI.git)
   cd mcTUI
...
Usa las flechas `↑/↓` para navegar, `Enter` para seleccionar y `Esc/q` para salir o volver atrás.
